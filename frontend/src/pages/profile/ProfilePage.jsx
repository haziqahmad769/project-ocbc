...
const ProfilePage = () => {
  ...
  const handleImgChange = (e, state) => {
    ...
    if (file) {
      ...
      state === "coverImg" && setCoverImg(file);
    }
  };
                ...
                <div className="avatar absolute -bottom-16 left-4">
                  <div className="w-32 rounded-full relative group/avatar">
                    <img
                      src={
                        profileImg
                          ? URL.createObjectURL(profileImg) // Preview the selected file
                          : user?.profileImg || "/avatar-placeholder.png" // Use user's profile image or placeholder
                      }
                    />
